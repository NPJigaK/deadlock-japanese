...
* ヒーロー `Mirage` のスキル `ファイアービートル` の説明文を修正しました。link:https://github.com/NPJigaK/deadlock-japanese/pull/10/files#diff-39b2fdc57205d589c5d6792ad351c498307bd832576e467dbe45deb6206f9825[#10]
