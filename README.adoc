...
* 起動オプションの誤記を修正しました。link:https://github.com/NPJigaK/deadlock-japanese/issues/13[#13]
* ヒーロー `Viscous` の3番目のアビリティが正しく表示されていない問題を修正しました。

### 2024/08/30 
* 最新版 `Build 5.106 2024/08/29 - 23:02:44` に対応しました。
* ヒーロー `Mirage` のアビリティ `ファイアービートル` の説明文を修正しました。link:https://github.com/NPJigaK/deadlock-japanese/pull/10/files[#10]
